...
class AdminViews:
    ...
    def add_new_emp(self) -> None:
        ...
        logger.info(Logs.NEW_USER_ADDED)
    ...
    def view_all(self) -> None:
        ...
        if data:
            ...
            #     print(
            #         tabulate(
            #             employees, headers=["UserID", "Email", "Vaccination Status"]
            #         )
            #     )
            #     time.sleep(5)
            display_table(data, ["UserID","Email", "Vaccination Status" ])
        else:
            print(Prints.NO_USER_EXISTS)
    ...
    def view_by_dose_date(self, dose_num: int) -> None:
        ...
        if not data:
            ...
            display_table(
                data, ["User ID", "email", "Vaccine Name", "Dose Date", "Dose CID"]
            )