...
class ApproveDoseInfoViews:
    ...
    def display_info_to_approve(self) -> bool:
        ...
        if data:
            display_table(
                data, ["Approval ID", "User ID", "Dose Num", "Dose CID", "Approved"]
            )
            return data
        else:
    ...
    def approve_dose_info(self) -> None:
        ...
        if response.upper() == "Y":
            ...
            logger.info(
                "Dose {} details approved for approval_id {}".format(
                    self.choice, approval_id
                )
            )
    ...
    def view_approved_details(self) -> None:
        ...
        if not data:
            ...
            display_table(
                data, ["Approval ID", "User ID", "Dose Number" "Dose CID", "Approved"]
            )
