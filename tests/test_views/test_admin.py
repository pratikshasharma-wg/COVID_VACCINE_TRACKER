...
class TestAdminViews:
    ...
    def test_admin_menu(self, mocker, obj_admin_views):
        mocker.patch('builtins.input', side_effect = ['1','2','3','4','5','6','9','7'])
        ...
        mocker.patch.object(obj_admin_views.approve_dose_info_obj, 'approve_dose_info_menu')
        mocker.patch.object(obj_admin_views.approve_dose_info_obj, 'view_approved_details')
    ...
    def test_view_emp(self, obj_admin_views, mocker):
        mocker.patch('builtins.input', side_effect=['1','2','3','4','5','6','7','9','8'])
    ...
    def test_view_all_negative(self, capsys, mocker, obj_admin_views):
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_all_users', return_value = None)
    ...
    def test_view_all_positive(self, capsys, mocker, obj_admin_views):
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_all_users', return_value = "abc")
        mock_obj = mocker.patch('views.admin.display_table')
        obj_admin_views.view_all()
        mock_obj.assert_called_once()

    def test_view_by_dose_positive(self, capsys, mocker, obj_admin_views):
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_users_by_dose', return_value = "abc")
        mock_obj = mocker.patch('views.admin.display_table')
        obj_admin_views.view_all()
        mock_obj.assert_called_once()

    def test_view_by_dose_negative(self, capsys, mocker, obj_admin_views):
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_users_by_dose', return_value = None)
    ...
    def test_view_by_vaccine_negative(self, capsys, mocker, obj_admin_views):
        mocker.patch.object(obj_admin_views.vaccine_obj, 'get_vaccine_name', return_value = "abc")
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_users_by_vaccine', return_value = None)
    ...
    def test_view_by_vaccine_positive(self, capsys, mocker, obj_admin_views):
        mocker.patch.object(obj_admin_views.vaccine_obj, 'get_vaccine_name', return_value = "abc")
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_users_by_vaccine', return_value = "abc")
        mock_obj = mocker.patch('views.admin.display_table')
        obj_admin_views.view_by_vaccine()
        mock_obj.assert_called_once()
    ...
    def test_view_by_dose_date_positive(self, mocker, obj_admin_views):
        ...
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_users_by_date', return_value = "abc")
        mock_obj = mocker.patch('views.admin.display_table')
    ...
    def test_view_by_dose_date_negative(self, capsys, mocker, obj_admin_views):
        mocker.patch('views.admin.input_valid_date', return_value = "1")
        mocker.patch.object(obj_admin_views.user_controller_obj, 'show_users_by_date', return_value = None)
        obj_admin_views.view_by_dose_date(1)
        captured = capsys.readouterr()
