...
class TestApproveDoseInfoViews:
    ...
    def test_display_info_to_approve_no_data(
        self, choice, capsys, mocker, obj_approve_dose
    ):
        obj_approve_dose.choice = choice
        mocker.patch.object(
            obj_approve_dose.approve_dose_controllers_obj,
            "show_info_to_approve",
            lambda a: None,
        )
    ...
    def test_approve_dose_info_no_data(self, mocker, obj_approve_dose):
        mocker.patch.object(
            obj_approve_dose, "display_info_to_approve", return_value=None
        )
    ...
    def test_approve_dose_info_data(self, capsys, mocker, obj_approve_dose):
        mocker.patch.object(
            obj_approve_dose, "display_info_to_approve", return_value="Data"
        )
